...
function create(){
	...
	var star2 = stars.create(0,0, 'star');
	star2.body.gravity.y =200;
	star2.body.bounce.y = 0.7 + Math.random() * 0.2;
	var star3 = stars.create(80,0, 'star');
